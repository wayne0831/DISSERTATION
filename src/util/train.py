...
def set_dataset(tr_start_idx, tr_end_idx, len_batch, X, y, X_cum, y_cum):
    """
    ...
    return X_cum, y_cum, X_tr, y_tr, X_te, y_te, tr_start_idx

# TODO: set_dataset 제외 코드 재작성
def run_ml_model_pipeline(tr_start_idx, tr_end_idx, len_batch, prob_type, perf_bnd, X, y, X_cum, y_cum, scaler, ml_mdl):
    """
    ...
    return X_cum, y_cum, X_te, y_te, y_pred_te, res_pred_idx, tr_end_idx, te_end_idx